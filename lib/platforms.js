...
module.exports = {
    win32: {
        ...
        files: { // First file must be the executable
            ...
            '>=0.12.0': ['nw.exe', 'ffmpeg.dll', 'icudtl.dat', 'libEGL.dll', 'resources.pak', 'dbghelp.dll', 'libexif.dll', 'nw_100_percent.pak', 'nw_200_percent.pak', 'libGLESv2.dll', 'locales', 'd3dcompiler_47.dll', 'nw_elf.dll', 'nw.dll', 'natives_blob.bin', 'snapshot_blob.bin', 'node.dll']
        },
